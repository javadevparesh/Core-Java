...
public class C_IntermediateOps {
    public static void main(String[] args) {
        ...
        Stream<String> filteredStream = list.stream().filter(x -> x.startsWith("A")); // Won't filter until Terminal operation
        // no filtering at this point (line-14)
